...
data from disk and returns it almost as is.
"""
...
class CocoCaptionsReader(Dataset):
    r"""
    A reader interface to read COCO Captions dataset and serialize the
    dataset to LMDB files.
